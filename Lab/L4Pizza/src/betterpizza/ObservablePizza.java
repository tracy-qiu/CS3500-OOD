...
public interface ObservablePizza {
   ...
   * @return the portion of this topping on this pizza, or null if the topping is not on this pizza
   */
  ...
  ObservablePizza build();

  ObservablePizza noTomato();

  ObservablePizza noSauce();

  ObservablePizza noJalapeno();
