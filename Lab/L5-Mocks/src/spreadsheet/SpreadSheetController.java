...
public class SpreadSheetController {
  ...
  /**
   * Spreadsheet controller constructor that creates a spreadsheet reading in inputs.
   *
   * @param sheet      spreadsheet object
   * @param readable   Readable input
   * @param appendable Appendable output
   */
  ...
  /**
   * This method is the interface for interacting with the spreadsheet such as reading and writing
   * values and showing the menu.
   *
   * @throws IllegalStateException if fails to set or read values
   */
  public void goSpreadsheet() throws IllegalStateException {
