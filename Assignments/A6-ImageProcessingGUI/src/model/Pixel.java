...
public class Pixel implements IPixel {
  ...
  /**
   * Method that applies a particular Greyscale option to the pixel. Utilize matrices for
   * specfic color transformation function of greyscale.
   *
  ...
  /**
   * color transformation sepia function for a given pixel.
   *
   * @return pixel that has had sepia color transformation applied to it.
   */
