...
public class ImageTest {
  ...
  @Test
  public void testGreyscaleMatrixLuma2x2() {
    ImageImpl fourByFour = null;
    try {
      fourByFour = readPPM("src/2x2.ppm");
    } catch (IOException e) {
    ...
    IImageProcessCommand matrixGreyscaleCommand =
            new GreyscaleImageProcessCommand("greyscale");
    ImageImpl matrixGreyscaleImage1 = matrixGreyscaleCommand.run(fourByFour);

    // pixel 1
    assertEquals(19, matrixGreyscaleImage1.getPixelAt(0, 0).getRed());
    assertEquals(19, matrixGreyscaleImage1.getPixelAt(0, 0).getGreen());
    assertEquals(19, matrixGreyscaleImage1.getPixelAt(0, 0).getBlue());
    // pixel 2
    assertEquals(74, matrixGreyscaleImage1.getPixelAt(0, 1).getRed());
    assertEquals(74, matrixGreyscaleImage1.getPixelAt(0, 1).getGreen());
    assertEquals(74, matrixGreyscaleImage1.getPixelAt(0, 1).getBlue());
    // pixel 3
    assertEquals(70, matrixGreyscaleImage1.getPixelAt(1, 0).getRed());
    assertEquals(70, matrixGreyscaleImage1.getPixelAt(1, 0).getGreen());
    assertEquals(70, matrixGreyscaleImage1.getPixelAt(1, 0).getBlue());
    //pixel 4
    assertEquals(48, matrixGreyscaleImage1.getPixelAt(1, 1).getRed());
    assertEquals(48, matrixGreyscaleImage1.getPixelAt(1, 1).getGreen());
    assertEquals(48, matrixGreyscaleImage1.getPixelAt(1, 1).getBlue());
  }
  ...
  @Test
  public void testMatrixGreyscaleLuma2x3() {
    ImageImpl twoByThree = null;
    try {
      twoByThree = readPPM("src/2x3.ppm");
    } catch (IOException e) {
    ...
    IImageProcessCommand matrixGreyscaleCommand =
            new GreyscaleImageProcessCommand("greyscale");
    ImageImpl matrixGreyscaleImage1 = matrixGreyscaleCommand.run(twoByThree);
    ...
    // pixel 5
    assertEquals(24, matrixGreyscaleImage1.getPixelAt(2, 0).getRed());
    assertEquals(24, matrixGreyscaleImage1.getPixelAt(2, 0).getGreen());
    assertEquals(24, matrixGreyscaleImage1.getPixelAt(2, 0).getBlue());
    //pixel 6
    assertEquals(93, matrixGreyscaleImage1.getPixelAt(2, 1).getRed());
    assertEquals(93, matrixGreyscaleImage1.getPixelAt(2, 1).getGreen());
    assertEquals(93, matrixGreyscaleImage1.getPixelAt(2, 1).getBlue());
  }
  ...
  @Test
  public void testBlur2x3ProcessComamnd() {
    ImageImpl twoByThree = null;
    try {
      twoByThree = readPPM("src/2x3.ppm");
    } catch (IOException e) {
    ...
    IImageProcessCommand blurCommand = new BlurImageProcessCommand();
    ImageImpl blurredImage1 = blurCommand.run(twoByThree);
    ...
    assertEquals(18, blurredImage1.getPixelAt(0, 1).getBlue());
    // pixel 3
    assertEquals(22, blurredImage1.getPixelAt(1, 0).getRed());
    assertEquals(40, blurredImage1.getPixelAt(1, 0).getGreen());
    assertEquals(81, blurredImage1.getPixelAt(1, 0).getBlue());
    //pixel 4
    assertEquals(34, blurredImage1.getPixelAt(1, 1).getRed());
    assertEquals(43, blurredImage1.getPixelAt(1, 1).getGreen());
    assertEquals(77, blurredImage1.getPixelAt(1, 1).getBlue());
    //pixel 5
    assertEquals(13, blurredImage1.getPixelAt(2, 0).getRed());
    assertEquals(26, blurredImage1.getPixelAt(2, 0).getGreen());
    assertEquals(108, blurredImage1.getPixelAt(2, 0).getBlue());
    //pixel 6
    assertEquals(15, blurredImage1.getPixelAt(2, 1).getRed());
    assertEquals(35, blurredImage1.getPixelAt(2, 1).getGreen());
    assertEquals(108, blurredImage1.getPixelAt(2, 1).getBlue());
  }

  @Test
  public void testSharpen2x3ProcessCommand() {
    ImageImpl twoByThree = null;
    try {
      twoByThree = readPPM("src/2x3.ppm");
    } catch (IOException e) {
    ...
    IImageProcessCommand sharpenCommand = new SharpenImageProcessCommand();
    ImageImpl sharpenImage1 = sharpenCommand.run(twoByThree);

    //pixel 1
    assertEquals(51, sharpenImage1.getPixelAt(0, 0).getRed());
    assertEquals(56, sharpenImage1.getPixelAt(0, 0).getGreen());
    assertEquals(10, sharpenImage1.getPixelAt(0, 0).getBlue());
    // pixel 2
    assertEquals(137, sharpenImage1.getPixelAt(0, 1).getRed());
    assertEquals(91, sharpenImage1.getPixelAt(0, 1).getGreen());

    // clamp value at 0
    assertEquals(0, sharpenImage1.getPixelAt(0, 1).getBlue());
    // pixel 3
    assertEquals(65, sharpenImage1.getPixelAt(1, 0).getRed());
    assertEquals(144, sharpenImage1.getPixelAt(1, 0).getGreen());
    assertEquals(240, sharpenImage1.getPixelAt(1, 0).getBlue());
    //pixel 4
    assertEquals(101, sharpenImage1.getPixelAt(1, 1).getRed());
    assertEquals(112, sharpenImage1.getPixelAt(1, 1).getGreen());
    assertEquals(222, sharpenImage1.getPixelAt(1, 1).getBlue());
    // pixel 5
    assertEquals(30, sharpenImage1.getPixelAt(2, 0).getRed());
    assertEquals(46, sharpenImage1.getPixelAt(2, 0).getGreen());
    // clamp value at 255
    assertEquals(255, sharpenImage1.getPixelAt(2, 0).getBlue());
    //pixel 6
    assertEquals(22, sharpenImage1.getPixelAt(2, 1).getRed());
    assertEquals(121, sharpenImage1.getPixelAt(2, 1).getGreen());
    // clamp value at 255
    assertEquals(255, sharpenImage1.getPixelAt(2, 1).getBlue());
  }
  ...
  @Test
  public void testMatrixGreyScaleLuma3x2() {
    ImageImpl threeByTwo = null;
    try {
      threeByTwo = readPPM("src/3x2.ppm");
    } catch (IOException e) {
    ...
    IImageProcessCommand matrixGreyscaleCommand =
            new GreyscaleImageProcessCommand("greyscale");
    ImageImpl matrixGreyscaleImage1 = matrixGreyscaleCommand.run(threeByTwo);
    ...
    assertEquals(74, matrixGreyscaleImage1.getPixelAt(0, 1).getBlue());
    // pixel 3
    assertEquals(70, matrixGreyscaleImage1.getPixelAt(0, 2).getRed());
    assertEquals(70, matrixGreyscaleImage1.getPixelAt(0, 2).getGreen());
    assertEquals(70, matrixGreyscaleImage1.getPixelAt(0, 2).getBlue());
    //pixel 4
    assertEquals(48, matrixGreyscaleImage1.getPixelAt(1, 0).getRed());
    assertEquals(48, matrixGreyscaleImage1.getPixelAt(1, 0).getGreen());
    assertEquals(48, matrixGreyscaleImage1.getPixelAt(1, 0).getBlue());

    // pixel 5
    assertEquals(20, matrixGreyscaleImage1.getPixelAt(1, 1).getRed());
    assertEquals(20, matrixGreyscaleImage1.getPixelAt(1, 1).getGreen());
    assertEquals(20, matrixGreyscaleImage1.getPixelAt(1, 1).getBlue());
    //pixel 6
    assertEquals(89, matrixGreyscaleImage1.getPixelAt(1, 2).getRed());
    assertEquals(89, matrixGreyscaleImage1.getPixelAt(1, 2).getGreen());
    assertEquals(89, matrixGreyscaleImage1.getPixelAt(1, 2).getBlue());
  }
  ...
  @Test
  public void testBlur3x2ProcessCommand() {
    ImageImpl threeByTwo = null;
    try {
      threeByTwo = readPPM("src/3x2.ppm");
    } catch (IOException e) {
    ...
    IImageProcessCommand blurCommand = new BlurImageProcessCommand();
    ImageImpl blurredImage1 = blurCommand.run(threeByTwo);

    //pixel 1
    assertEquals(26, blurredImage1.getPixelAt(0, 0).getRed());
    assertEquals(18, blurredImage1.getPixelAt(0, 0).getGreen());
    assertEquals(29, blurredImage1.getPixelAt(0, 0).getBlue());
    // pixel 2
    assertEquals(41, blurredImage1.getPixelAt(0, 1).getRed());
    assertEquals(38, blurredImage1.getPixelAt(0, 1).getGreen());
    assertEquals(57, blurredImage1.getPixelAt(0, 1).getBlue());
    // pixel 3
    assertEquals(21, blurredImage1.getPixelAt(0, 2).getRed());
    assertEquals(42, blurredImage1.getPixelAt(0, 2).getGreen());
    assertEquals(60, blurredImage1.getPixelAt(0, 2).getBlue());
    //pixel 4
    assertEquals(26, blurredImage1.getPixelAt(1, 0).getRed());
    assertEquals(17, blurredImage1.getPixelAt(1, 0).getGreen());
    assertEquals(45, blurredImage1.getPixelAt(1, 0).getBlue());
    //pixel 5
    assertEquals(32, blurredImage1.getPixelAt(1, 1).getRed());
    assertEquals(32, blurredImage1.getPixelAt(1, 1).getGreen());
    assertEquals(91, blurredImage1.getPixelAt(1, 1).getBlue());
    //pixel 6
    assertEquals(16, blurredImage1.getPixelAt(1, 2).getRed());
    assertEquals(39, blurredImage1.getPixelAt(1, 2).getGreen());
    assertEquals(86, blurredImage1.getPixelAt(1, 2).getBlue());
  }

  @Test
  public void testSharpen3x2ProcessCommand() {
    ImageImpl threeByTwo = null;
    try {
      threeByTwo = readPPM("src/3x2.ppm");
    } catch (IOException e) {
    ...
    IImageProcessCommand sharpenCommand = new SharpenImageProcessCommand();
    ImageImpl sharpenImage1 = sharpenCommand.run(threeByTwo);

    //pixel 1
    assertEquals(59, sharpenImage1.getPixelAt(0, 0).getRed());
    assertEquals(24, sharpenImage1.getPixelAt(0, 0).getGreen());
    assertEquals(64, sharpenImage1.getPixelAt(0, 0).getBlue());
    // pixel 2
    assertEquals(154, sharpenImage1.getPixelAt(0, 1).getRed());
    assertEquals(128, sharpenImage1.getPixelAt(0, 1).getGreen());
    assertEquals(150, sharpenImage1.getPixelAt(0, 1).getBlue());
    // pixel 3
    assertEquals(41, sharpenImage1.getPixelAt(0, 2).getRed());
    assertEquals(120, sharpenImage1.getPixelAt(0, 2).getGreen());
    assertEquals(178, sharpenImage1.getPixelAt(0, 2).getBlue());
    //pixel 4
    assertEquals(92, sharpenImage1.getPixelAt(1, 0).getRed());
    assertEquals(42, sharpenImage1.getPixelAt(1, 0).getGreen());
    assertEquals(88, sharpenImage1.getPixelAt(1, 0).getBlue());

    // pixel 5
    assertEquals(81, sharpenImage1.getPixelAt(1, 1).getRed());
    assertEquals(79, sharpenImage1.getPixelAt(1, 1).getGreen());
    // clamp at 200
    assertEquals(200, sharpenImage1.getPixelAt(1, 1).getBlue());
    // pixel 6
    assertEquals(48, sharpenImage1.getPixelAt(1, 2).getRed());
    assertEquals(129, sharpenImage1.getPixelAt(1, 2).getGreen());
    // clamp at 200
    assertEquals(200, sharpenImage1.getPixelAt(1, 2).getBlue());
  }
