...
public class CommandsTest {
  ...
  @Test
  public void testMatrixGreyscaleLumaCommand() {
    ImageModel model1 = new ImageModelImpl();
    ImageImpl twoByThree = null;
    ...
    model1.addImage("twoByThree", twoByThree);
    ImageCommand matrixGreyscale =
            new Greyscale("greyscale",
                    "twoByThree", "twoByThree-greyscale");

    try {
      matrixGreyscale.goCommand(model1);
    } catch (IOException e) {
      fail();
    }

    ImageImpl matrixGreyscaleImage1 = model1.getImageAt("twoByThree-greyscale");
  ...
  @Test
  public void testSepia2x3Command() {
    ImageModel model1 = new ImageModelImpl();
    ImageImpl twoByThree = null;
    try {
      twoByThree = readPPM("src/2x3.ppm");
    ...
    model1.addImage("twoByThree", twoByThree);
    ImageCommand sepiaCommand =
            new Sepia("twoByThree", "twoByThree-sepia");

    try {
      sepiaCommand.goCommand(model1);
    } catch (IOException e) {
      fail();
    }

    ImageImpl sepiaImage1 = model1.getImageAt("twoByThree-sepia");
  ...
  @Test
  public void testBlur2x3Command() {
    ImageModel model1 = new ImageModelImpl();
    ImageImpl twoByThree = null;
    try {
      twoByThree = readPPM("src/2x3.ppm");
    ...
    model1.addImage("twoByThree", twoByThree);
    ImageCommand blur =
            new Blur("twoByThree", "twoByThree-blur");

    try {
      blur.goCommand(model1);
    } catch (IOException e) {
      fail();
    }

    ImageImpl blurredImage1 = model1.getImageAt("twoByThree-blur");
  ...
  @Test
  public void testSharpen2x3Command() {
    ImageModel model1 = new ImageModelImpl();
    ImageImpl twoByThree = null;
    try {
      twoByThree = readPPM("src/2x3.ppm");
    ...
    model1.addImage("twoByThree", twoByThree);
    ImageCommand sharpenCommand =
            new Sharpen("twoByThree", "twoByThree-sharpen");

    try {
      sharpenCommand.goCommand(model1);
    } catch (IOException e) {
      fail();
    }

    ImageImpl sharpenImage1 = model1.getImageAt("twoByThree-sharpen");
