...
public class ControllerTest {
  ...
  // blur of image 1
  Pixel pixel1_blur = new Pixel(22, 26, 24, 255);
  Pixel pixel2_blur = new Pixel(39, 29, 18, 255);
  Pixel pixel3_blur = new Pixel(17, 33, 35, 255);
  Pixel pixel4_blur = new Pixel(30, 31, 30, 255);
  Pixel[][] pixelArray_blur =
      {{pixel1_blur, pixel2_blur}, {pixel3_blur, pixel4_blur}};

  // sharpen of image 1
  Pixel pixel1_sharpen = new Pixel(56, 69, 72, 255);
  Pixel pixel2_sharpen = new Pixel(143, 103, 50, 255);
  Pixel pixel3_sharpen = new Pixel(54, 119, 115, 255);
  Pixel pixel4_sharpen = new Pixel(90, 87, 97, 255);
  Pixel[][] pixelArray_sharpen =
      {{pixel1_sharpen, pixel2_sharpen}, {pixel3_sharpen, pixel4_sharpen}};

  // sepia of image 1
  Pixel pixel1_sepia = new Pixel(26, 23, 18, 255);
  Pixel pixel2_sepia = new Pixel(100, 89, 70, 255);
  Pixel pixel3_sepia = new Pixel(87, 77, 60, 255);
  Pixel pixel4_sepia = new Pixel(68, 60, 47, 255);
  Pixel[][] pixelArray_sepia =
      {{pixel1_sepia, pixel2_sepia}, {pixel3_sepia, pixel4_sepia}};
  ...
  ImageImpl image1_blur = new ImageImpl(width, height, maxValue, pixelArray_blur);

  ImageImpl image1_sharpen = new ImageImpl(width, height, maxValue, pixelArray_sharpen);

  ImageImpl image1_sepia = new ImageImpl(width, height, maxValue, pixelArray_sepia);
  ...
  @Test
  public void testValidLoadSaveImageFile() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load res/stickfigure.png originalPNG\n "
                    + "load res/stickfigure.jpg originalJPG\n"
                    + "load res/stickfigure.bmp originalBMP\n"
                    + "save res/stickfigure.png originalPNG\n"
                    + "save res/stickfigure.jpg originalJPG\n"
                    + "save res/stickfigure.bmp originalBMP\n "
                    + "save res/stickfigurePNGtoJPG.jpg originalPNG\n "
                    + "save res/stickfigureJPGtoBMP.bmp originalJPG\n Q");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
    ...
    assertEquals("load command successful\n"
            ...
            + "Quit program\n", controllerOutput.toString());
    try {
      assertEquals(model.getImageAt("originalPNG"),
              ImageUtil.readImageFile("res/stickfigure.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("originalJPG"),
              ImageUtil.readImageFile("res/stickfigure.jpg"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("originalBMP"),
              ImageUtil.readImageFile("res/stickfigure.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("originalPNG"),
              ImageUtil.readImageFile("res/stickfigurePNGtoJPG.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("originalJPG"),
              ImageUtil.readImageFile("res/stickfigureJPGtoBMP.bmp"));
    } catch (IOException e) {
      fail();
    }
  }
  ...
  @Test
  public void testValidLoadGivenPNGFiles() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load res/stickfigure.png original\n "
                    + "value-component original value-component\n "
                    + "intensity-component original intensity-component\n "
                    + "luma-component original luma-component\n "
                    + "red-component original red-component\n "
                    ...
                    + "brighten 50 original brighten50\n Q");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
    ...
    //    try {
    //      assertEquals(model.getImageAt("value-component"),
    //              ImageUtil.readImageFile("res/stickfigure-value-greyscale.png"));
    //    } catch (IOException e) {
    //      fail();
    //    }
    //
    //    try {
    //      assertEquals(model.getImageAt("intensity-component"),
    //              ImageUtil.readImageFile("res/stickfigure-intensity-greyscale.png"));
    //    } catch (IOException e) {
    //      fail();
    //    }
    //    try {
    //      assertEquals(model.getImageAt("luma-component"),
    //              ImageUtil.readImageFile("res/stickfigure-luma-greyscale.png"));
    //    } catch (IOException e) {
    //      fail();
    //    }
    ...
    try {
      assertEquals(model.getImageAt("red-component"),
              ImageUtil.readImageFile("res/stickfigure-red-greyscale.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("green-component"),
              ImageUtil.readImageFile("res/stickfigure-green-greyscale.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("blue-component"),
              ImageUtil.readImageFile("res/stickfigure-blue-greyscale.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal"),
              ImageUtil.readImageFile("res/stickfigure-horizontal.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("horizontal-vertical"),
              ImageUtil.readImageFile("res/stickfigure-horizontal-vertical.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("vertical"),
              ImageUtil.readImageFile("res/stickfigure-vertical.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("vertical-horizontal"),
              ImageUtil.readImageFile("res/stickfigure-vertical-horizontal.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("brighten50"),
              ImageUtil.readImageFile("res/stickfigure-brighter-by-50.png"));
    } catch (IOException e) {
      fail();
    }
  ...
  @Test
  public void testValidSavePNGFile() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load res/stickfigure.png original\n "
                    + "value-component original value-component\n "
                    ...
                    + "luma-component red-component luma-red-component\n"
                    + "value-component green-component value-green-component\n"
                    + "greyscale original greyscale\n"
                    + "horizontal-flip original horizontal\n"
                    + "brighten 10 original brighten10\n"
                    + "brighten -50 original darken50\n"
                    + "blur original blur1\n"
                    + "blur blur1 blur2\n"
                    + "blur blur2 blur3\n"
                    + "sepia original sepia\n"
                    + "sharpen original sharpen\n"
                    + "save res/stickfigureValue.png value-component\n"
                    + "save res/stickfigureIntensity.png intensity-component\n"
                    + "save res/stickfigureLuma.png luma-component\n"
                    + "save res/stickfigureRed.png red-component\n"
                    + "save res/stickfigureGreen.png green-component\n"
                    + "save res/stickfigureBlue.png blue-component\n"
                    + "save res/stickfigureLuma-red.png luma-red-component\n "
                    + "save res/stickfigureValue-green.png value-green-component\n"
                    + "save res/stickfigure-greyscale.png greyscale\n"
                    + "save res/stickfigureHorizontal.png horizontal\n"
                    + "save res/stickfigureBrighten10.png brighten10\n "
                    + "save res/stickfigureDarken50.png darken50\n "
                    + "save res/stickfigureBlur.png blur3\n "
                    + "save res/stickfigureSharpen.png sharpen\n "
                    + "save res/stickfigureSepia.png sepia\nQ");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
    ...
    try {
      assertEquals(model.getImageAt("value-component"),
              ImageUtil.readImageFile("res/stickfigureValue.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("intensity-component"),
              ImageUtil.readImageFile("res/stickfigureIntensity.png"));
    } catch (IOException e) {
      fail();
    }
    try {
      assertEquals(model.getImageAt("luma-component"),
              ImageUtil.readImageFile("res/stickfigureLuma.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("red-component"),
              ImageUtil.readImageFile("res/stickfigureRed.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("green-component"),
              ImageUtil.readImageFile("res/stickfigureGreen.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("blue-component"),
              ImageUtil.readImageFile("res/stickfigureBlue.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("luma-red-component"),
              ImageUtil.readImageFile("res/stickfigureLuma-red.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("value-green-component"),
              ImageUtil.readImageFile("res/stickfigureValue-green.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("greyscale"),
              ImageUtil.readImageFile("res/stickfigure-greyscale.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal"),
              ImageUtil.readImageFile("res/stickfigureHorizontal.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("brighten10"),
              ImageUtil.readImageFile("res/stickfigureBrighten10.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("darken50"),
              ImageUtil.readImageFile("res/stickfigureDarken50.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("blur3"),
              ImageUtil.readImageFile("res/stickfigureBlur.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("sharpen"),
              ImageUtil.readImageFile("res/stickfigureSharpen.png"));
    } catch (IOException e) {
      fail();
    }

    try {
      assertEquals(model.getImageAt("sepia"),
              ImageUtil.readImageFile("res/stickfigureSepia.png"));
    } catch (IOException e) {
      fail();
    }
  }
  ...
  @Test
  public void testValidSaveJPGFile() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load res/stickfigure.jpg original\n "
                    + "value-component original value-component\n "
                    + "intensity-component original intensity-component\n "
                    + "luma-component original luma-component\n "
                    + "red-component original red-component\n "
                    ...
                    + "brighten 10 original brighten10\n"
                    + "brighten -50 original darken50\n"
                    + "save res/stickfigureValue.jpg value-component\n"
                    + "save res/stickfigureIntensity.jpg intensity-component\n"
                    + "save res/stickfigureLuma.jpg luma-component\n"
                    + "save res/stickfigureRed.jpg red-component\n"
                    + "save res/stickfigureGreen.jpg green-component\n"
                    + "save res/stickfigureBlue.jpg blue-component\n"
                    + "save res/stickfigureLuma-red.jpg luma-red-component\n "
                    + "save res/stickfigureValue-green.jpg value-green-component\n"
                    + "save res/stickfigureHorizontal.jpg horizontal\n"
                    + "save res/stickfigureBrighten10.jpg brighten10\n "
                    + "save res/stickfigureDarken50.jpg darken50\n Q");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
    ...
    try {
      assertEquals(model.getImageAt("value-component"),
              ImageUtil.readImageFile("res/stickfigureValue.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("intensity-component"),
              ImageUtil.readImageFile("res/stickfigureIntensity.jpg"));
    } catch (IOException e) {
      fail();
    }
    try {
      assertEquals(model.getImageAt("luma-component"),
              ImageUtil.readImageFile("res/stickfigureLuma.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("red-component"),
              ImageUtil.readImageFile("res/stickfigureRed.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("green-component"),
              ImageUtil.readImageFile("res/stickfigureGreen.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("blue-component"),
              ImageUtil.readImageFile("res/stickfigureBlue.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("luma-red-component"),
              ImageUtil.readImageFile("res/stickfigureLuma-red.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("value-green-component"),
              ImageUtil.readImageFile("res/stickfigureValue-green.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal"),
              ImageUtil.readImageFile("res/stickfigureHorizontal.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("brighten10"),
              ImageUtil.readImageFile("res/stickfigureBrighten10.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("darken50"),
              ImageUtil.readImageFile("res/stickfigureDarken50.jpg"));
    } catch (IOException e) {
      fail();
    }
  ...
  @Test
  public void testValidSaveBMPFile() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load res/stickfigure.bmp original\n "
                    + "value-component original value-component\n "
                    + "intensity-component original intensity-component\n "
                    + "luma-component original luma-component\n "
                    + "red-component original red-component\n "
                    ...
                    + "brighten 10 original brighten10\n"
                    + "brighten -50 original darken50\n"
                    + "save res/stickfigureValue.bmp value-component\n"
                    + "save res/stickfigureIntensity.bmp intensity-component\n"
                    + "save res/stickfigureLuma.bmp luma-component\n"
                    + "save res/stickfigureRed.bmp red-component\n"
                    + "save res/stickfigureGreen.bmp green-component\n"
                    + "save res/stickfigureBlue.bmp blue-component\n"
                    + "save res/stickfigureLuma-red.bmp luma-red-component\n "
                    + "save res/stickfigureValue-green.bmp value-green-component\n"
                    + "save res/stickfigureHorizontal.bmp horizontal\n"
                    + "save res/stickfigureBrighten10.bmp brighten10\n "
                    + "save res/stickfigureDarken50.bmp darken50\n Q");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
    ...
    try {
      assertEquals(model.getImageAt("value-component"),
              ImageUtil.readImageFile("res/stickfigureValue.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("intensity-component"),
              ImageUtil.readImageFile("res/stickfigureIntensity.bmp"));
    } catch (IOException e) {
      fail();
    }
    try {
      assertEquals(model.getImageAt("luma-component"),
              ImageUtil.readImageFile("res/stickfigureLuma.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("red-component"),
              ImageUtil.readImageFile("res/stickfigureRed.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("green-component"),
              ImageUtil.readImageFile("res/stickfigureGreen.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("blue-component"),
              ImageUtil.readImageFile("res/stickfigureBlue.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("luma-red-component"),
              ImageUtil.readImageFile("res/stickfigureLuma-red.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("value-green-component"),
              ImageUtil.readImageFile("res/stickfigureValue-green.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal"),
              ImageUtil.readImageFile("res/stickfigureHorizontal.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("brighten10"),
              ImageUtil.readImageFile("res/stickfigureBrighten10.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("darken50"),
              ImageUtil.readImageFile("res/stickfigureDarken50.bmp"));
    } catch (IOException e) {
      fail();
    }
  ...
  public void testValidGreyscale() {
    ...
    assertEquals(image1_luma, model.getImageAt("greyscale"));
  }
  ...
  public void testValidBlur() {
    ...
    assertEquals("load command successful\n"
            ...
            + "Quit program\n", controllerOutput.toString());
    assertEquals(image1, model.getImageAt("original"));
    assertEquals(image1_blur, model.getImageAt("blur"));
  }
  ...
  public void testValidSharpen() {
    ...
    assertEquals("load command successful\n"
            ...
            + "Quit program\n", controllerOutput.toString());
    assertEquals(image1, model.getImageAt("original"));
    assertEquals(image1_sharpen, model.getImageAt("sharpen"));
  }
  ...
  public void testValidSepia() {
    ...
    assertEquals("load command successful\n"
            ...
            + "Quit program\n", controllerOutput.toString());
    assertEquals(image1, model.getImageAt("original"));
    assertEquals(image1_sepia, model.getImageAt("sepia"));
  }
  ...
  @Test
  public void testValidCommandsFromCLIFileArgument() throws FileNotFoundException {
    ImageModel model = new ImageModelImpl();
    Readable input = null;
    try {
      input = new FileReader("src/commandLineTest.txt");
    ...
    assertEquals(image1_blue, model.getImageAt("blue-greyscale"));
    assertEquals(image1_hv, model.getImageAt("vertical-horizontal"));
    assertEquals(image1_blue_d30, model.getImageAt("blue-greyscale-darken30"));
    assertEquals(image2, model.getImageAt("original"));
  }
