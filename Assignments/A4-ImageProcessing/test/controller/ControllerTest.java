...
public class ControllerTest {
  ...
  // blue greyscale darken 30 of image 1
  ...
  public void testValidLoadSaveImageFile() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load images/koala-vertical.png original\n "
                    + "vertical-flip original vertical\n "
                    + "save images/koala.png vertical\n "
                    + "save images/koala.jpg vertical\n "
                    + "save images/koala.bmp vertical\n Q");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
    ...
    try {
      assertEquals(model.getImageAt("vertical"),
              ImageUtil.readImageFile("images/koala.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("vertical"),
              ImageUtil.readImageFile("images/koala.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("vertical"),
              ImageUtil.readImageFile("images/koala.bmp"));
    } catch (IOException e) {
      fail();
    }
  }
  ...
  public void testValidLoadGivenPNGFiles() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load images/koala.png original\n "
                    + "value-component original value-component\n "
                    + "intensity-component original intensity-component\n "
                    + "luma-component original luma-component\n "
                    + "red-component original red-component\n "
...
//                    + "save images/res/koalaValue.png value-component\n"
//                    + "save images/res/koalaIntensity.png intensity-component\n"
//                    + "save images/res/koalaLuma.png luma-component\n"
//                    + "save images/res/koalaRed.png red-component\n"
//                    + "save images/res/koalaGreen.png green-component\n"
//                    + "save images/res/koalaBlue.png blue-component\n"
//                    + "save images/res/koalaLuma-red.png luma-red-component\n "
//                    + "save images/res/koalaValue-green.png value-green-component\n"
//                    + "save images/res/koalaHorizontal.png horizontal\n"
//                    + "save images/res/koalaBrighten10.png brighten10\n "
//                    + "save images/res/koalaDarken50.png darken50\n Q");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
...
//    try {
//      assertEquals(model.getImageAt("value-component"),
//              ImageUtil.readImageFile("images/koala-value-greyscale.png"));
//    } catch (IOException e) {
//      fail();
//    }
//
//    try {
//      assertEquals(model.getImageAt("intensity-component"),
//              ImageUtil.readImageFile("images/koala-intensity-greyscale.png"));
//    } catch (IOException e) {
//      fail();
//    }
//    try {
//      assertEquals(model.getImageAt("luma-component"),
//              ImageUtil.readImageFile("images/koala-luma-greyscale.png"));
//    } catch (IOException e) {
//      fail();
//    }
    ...
    try {
      assertEquals(model.getImageAt("red-component"),
              ImageUtil.readImageFile("images/koala-red-greyscale.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("green-component"),
              ImageUtil.readImageFile("images/koala-green-greyscale.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("blue-component"),
              ImageUtil.readImageFile("images/koala-blue-greyscale.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal"),
              ImageUtil.readImageFile("images/koala-horizontal.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal-vertical"),
              ImageUtil.readImageFile("images/koala-horizontal-vertical.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("vertical"),
              ImageUtil.readImageFile("images/koala-vertical.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("vertical-horizontal"),
              ImageUtil.readImageFile("images/koala-vertical-horizontal.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("brighten50"),
              ImageUtil.readImageFile("images/koala-brighter-by-50.png"));
    } catch (IOException e) {
      fail();
    }
  ...
  public void testValidSavePNGFile() {
    ...
    try {
      assertEquals(model.getImageAt("value-component"),
              ImageUtil.readImageFile("images/res/koalaValue.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("intensity-component"),
              ImageUtil.readImageFile("images/res/koalaIntensity.png"));
    } catch (IOException e) {
      fail();
    }
    try {
      assertEquals(model.getImageAt("luma-component"),
              ImageUtil.readImageFile("images/res/koalaLuma.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("red-component"),
              ImageUtil.readImageFile("images/res/koalaRed.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("green-component"),
              ImageUtil.readImageFile("images/res/koalaGreen.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("blue-component"),
              ImageUtil.readImageFile("images/res/koalaBlue.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("luma-red-component"),
              ImageUtil.readImageFile("images/res/koalaLuma-red.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("value-green-component"),
              ImageUtil.readImageFile("images/res/koalaValue-green.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal"),
              ImageUtil.readImageFile("images/res/koalaHorizontal.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("brighten10"),
              ImageUtil.readImageFile("images/res/koalaBrighten10.png"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("darken50"),
              ImageUtil.readImageFile("images/res/koalaDarken50.png"));
    } catch (IOException e) {
      fail();
    }
  ...
  public void testValidSaveJPGFile() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load images/koala.jpg original\n "
                    + "value-component original value-component\n "
                    + "intensity-component original intensity-component\n "
                    + "luma-component original luma-component\n "
                    + "red-component original red-component\n "
                    ...
                    + "brighten 10 original brighten10\n"
                    + "brighten -50 original darken50\n"
                    + "save images/res/koalaValue.jpg value-component\n"
                    + "save images/res/koalaIntensity.jpg intensity-component\n"
                    + "save images/res/koalaLuma.jpg luma-component\n"
                    + "save images/res/koalaRed.jpg red-component\n"
                    + "save images/res/koalaGreen.jpg green-component\n"
                    + "save images/res/koalaBlue.jpg blue-component\n"
                    + "save images/res/koalaLuma-red.jpg luma-red-component\n "
                    + "save images/res/koalaValue-green.jpg value-green-component\n"
                    + "save images/res/koalaHorizontal.jpg horizontal\n"
                    + "save images/res/koalaBrighten10.jpg brighten10\n "
                    + "save images/res/koalaDarken50.jpg darken50\n Q");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
    ...
    try {
      assertEquals(model.getImageAt("value-component"),
              ImageUtil.readImageFile("images/res/koalaValue.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("intensity-component"),
              ImageUtil.readImageFile("images/res/koalaIntensity.jpg"));
    } catch (IOException e) {
      fail();
    }
    try {
      assertEquals(model.getImageAt("luma-component"),
              ImageUtil.readImageFile("images/res/koalaLuma.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("red-component"),
              ImageUtil.readImageFile("images/res/koalaRed.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("green-component"),
              ImageUtil.readImageFile("images/res/koalaGreen.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("blue-component"),
              ImageUtil.readImageFile("images/res/koalaBlue.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("luma-red-component"),
              ImageUtil.readImageFile("images/res/koalaLuma-red.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("value-green-component"),
              ImageUtil.readImageFile("images/res/koalaValue-green.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal"),
              ImageUtil.readImageFile("images/res/koalaHorizontal.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("brighten10"),
              ImageUtil.readImageFile("images/res/koalaBrighten10.jpg"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("darken50"),
              ImageUtil.readImageFile("images/res/koalaDarken50.jpg"));
    } catch (IOException e) {
      fail();
    }
  ...
  public void testValidSaveBMPFile() {
    ImageModel model = new ImageModelImpl();
    Appendable input = new StringBuilder(
            "load images/koala.bmp original\n "
                    + "value-component original value-component\n "
                    + "intensity-component original intensity-component\n "
                    + "luma-component original luma-component\n "
                    + "red-component original red-component\n "
                    ...
                    + "brighten 10 original brighten10\n"
                    + "brighten -50 original darken50\n"
                    + "save images/res/koalaValue.bmp value-component\n"
                    + "save images/res/koalaIntensity.bmp intensity-component\n"
                    + "save images/res/koalaLuma.bmp luma-component\n"
                    + "save images/res/koalaRed.bmp red-component\n"
                    + "save images/res/koalaGreen.bmp green-component\n"
                    + "save images/res/koalaBlue.bmp blue-component\n"
                    + "save images/res/koalaLuma-red.bmp luma-red-component\n "
                    + "save images/res/koalaValue-green.bmp value-green-component\n"
                    + "save images/res/koalaHorizontal.bmp horizontal\n"
                    + "save images/res/koalaBrighten10.bmp brighten10\n "
                    + "save images/res/koalaDarken50.bmp darken50\n Q");
    Readable userInput = new StringReader(input.toString());
    Appendable controllerOutput = new StringBuilder();
    ImageView view = new ImageViewImpl(model, controllerOutput);
    ImageController controller = new ImageControllerImpl(model, view, userInput);
    ...
    try {
      assertEquals(model.getImageAt("value-component"),
              ImageUtil.readImageFile("images/res/koalaValue.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("intensity-component"),
              ImageUtil.readImageFile("images/res/koalaIntensity.bmp"));
    } catch (IOException e) {
      fail();
    }
    try {
      assertEquals(model.getImageAt("luma-component"),
              ImageUtil.readImageFile("images/res/koalaLuma.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("red-component"),
              ImageUtil.readImageFile("images/res/koalaRed.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("green-component"),
              ImageUtil.readImageFile("images/res/koalaGreen.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("blue-component"),
              ImageUtil.readImageFile("images/res/koalaBlue.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("luma-red-component"),
              ImageUtil.readImageFile("images/res/koalaLuma-red.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("value-green-component"),
              ImageUtil.readImageFile("images/res/koalaValue-green.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("horizontal"),
              ImageUtil.readImageFile("images/res/koalaHorizontal.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("brighten10"),
              ImageUtil.readImageFile("images/res/koalaBrighten10.bmp"));
    } catch (IOException e) {
      fail();
    }
    ...
    try {
      assertEquals(model.getImageAt("darken50"),
              ImageUtil.readImageFile("images/res/koalaDarken50.bmp"));
    } catch (IOException e) {
      fail();
    }
  ...
  public void testValidCommandsFromREADME() {
    ...
    Appendable input = new StringBuilder(
            "load src/2x2.ppm original\n "
                    ...
                    + "horizontal-flip vertical vertical-horizontal\n"
                    + "brighten -30 blue-greyscale blue-greyscale-darken30\n"
                    + "save src/res/vertical-horizontal.ppm vertical-horizontal\n"
                    + "save src/res/blue-greyscale-darken30.ppm blue-greyscale-darken30\n"
